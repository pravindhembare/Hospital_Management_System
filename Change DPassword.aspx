<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage5.master" AutoEventWireup="true" CodeFile="Change DPassword.aspx.cs" Inherits="Change_DPassword" %>
...
<table align=right style="z-index: 101;  color: #ffffff; font-family: 'Lucida Console';">
<tr><td colspan=2 align=center><img src="Pictures/images%20(3).jpg" 
        style="height: 151px; width: 168px" /></td></tr>
<tr bgcolor="#FBF6F6"><td style="height: 34px; width:176px; color: #000000;">Department</td>
<td style="height: 34px; width:157px;">
    <asp:Label ID="Label2" runat="server" ForeColor="Black" Text=""></asp:Label>
...
<td style="height: 34px; width:157px;">
    <asp:TextBox ID="TextBoxp5" runat="server" Width="120px"></asp:TextBox></td>
...
<tr bgcolor="#FBF6F6"><td style="height: 34px; width:176px; color: #000000;">
   New Password</td>
<td style="height: 34px; width:157px;">
    <asp:TextBox ID="TextBoxp2" runat="server" Width="122px"></asp:TextBox></td>
